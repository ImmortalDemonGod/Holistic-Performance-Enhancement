    ...
    date: 2025-05-07
    week: 2
    session: "Recovery jog + mobility"
    duration_min: 17
    hr_target: "65–70 % HRₘₐₓ (≤ 150 bpm)"
    purpose: "Capillary flush"
    ---
    # Base‑Ox • Week 2 – Wed 2025-05-07

    **Session**: Recovery jog + mobility  
    **Planned Duration**: 17 min  
    **Heart‑rate Target**: 65–70 % HRₘₐₓ (≤ 150 bpm)  
